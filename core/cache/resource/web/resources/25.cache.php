<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1495734003,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1495734003,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<body>
  <div class="top-block">
             ...
             <div class="col-md-5">
               <nav>
                 <ul class="list-inline">
                   ...
                   <li ><a href="/sushirolls" title="link">Роллы</a></li>
    ...
    [[!FormIt?
      ...
      &emailSubject=`В интернет-магазине "NikitaDiploma" сделан новый заказ`

      &fiarSubject=`Вы сделали заказ в интернет-магазине "NikitaDiploma"`

      &emailTo=`nikita.irutzky@yandex.ru`

      &fiarReplyTo=`nikita.irutzky@yandex.ru`

      &fiarToField=`email`

      &emailFrom=`nikita.irutzky@yandex.ru`

      &emailFromName=`nikita.irutzky@yandex.ru`

      &fiarFrom=`nikita.irutzky@yandex.ru`
...
<form method="post" action="checkbox.html" id="shopOrderForm">
...
<table cellpadding="3">
    <tr>
        <td>Ф.И.О.*:</td>
        <td>
            <input name="fullname" size="30" class="textfield" type="text" value="[[!+fi.fullname:default=`Администратор по умолчанию`:ne=`0`:show]]" />
    ...
    <tr>
        <td>Адрес*:</td>
        <td>
              <input name="address" size="30" class="textfield" type="text" value="[[!+fi.address:default=``:ne=`0`:show]]" />
    ...
    <tr>
        <td>E-mail*:</td>
        <td>
            <input name="email" size="30" class="textfield" type="text" value="[[!+fi.email:default=`nikita.irutzky@yandex.ru`:ne=`0`:show]]" />
    ...
    <tr>
        <td>Телефон*:</td>
        <td>
            <input name="phone" size="30" class="textfield" type="text" value="[[!+fi.phone:default=``:ne=`0`:show]]" />
